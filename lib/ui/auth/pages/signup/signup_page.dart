...
import 'package:application/ui/auth/pages/signup/signup_controller.dart';
...
class SignupPage extends GetView<SignupController> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        controller.obx(
            (state) => ConstantsButton("Cadastrar", true, onPressed: () {
                  controller.setUsername();
                }),
            onEmpty: ConstantsButton("Cadastrar", true, onPressed: () {
              controller.setUsername();
            }),
            onError: (error) =>
                ConstantsButton("Cadastrar", true, onPressed: () {
                  controller.setUsername();
                }),
            onLoading: Padding(
        ...
        ConstantsButton("Faça login", false, onPressed: () {
          controller.login();
        }),
      ],
    );
  ...
  Widget ConstantsButton(String title, bool scale,
