...
class RegisterCardsView extends GetView<RegisterCardsController> {
  RegisterCardsView() {
    Get.put(RegisterCardsController());
  }
  ...
  Widget build(Object context) {
    ...
    return Scaffold(
        ...
        body: SafeArea(
            child: Container(
                color: Color.lerp(Constants.background, Constants.purple, 0.7),
                child: Stack(
                  children: [
                    Background(
                                                            ...
                                                            child: ClipRRect(
                                                              ...
                                                              child:
                                                                ...
                                                                child:
                                                                  ...
                                                                  decoration:
                                                                      BoxDecoration(
                                                                          color: Constants.purple.withOpacity(
                                                                              0.2),
